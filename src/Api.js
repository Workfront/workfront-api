 ...
 *     <code>alwaysUseGet</code> {Boolean} - Defaults to false. Will cause the api to make every request as a GET with params in the querey string and add method=DESIRED_METHOD_TYPE in the querey string. Some Workfront urls will have issues with PUT and DELETE calls if this value is false.<br/>
